    ...
    <div class="container w-100 py-4 px-5 shadow-lg mb-5 rounded">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <asp:TextBox ID="txtBuscarOrdenTrabajo" TextMode="Number"  min="1" max="99999999" CssClass="form-control" required runat="server"></asp:TextBox>
            </div>
            <div class="col-md-6">
        ...
        <asp:Button ID="btnModificarOrdenTrabajo" CssClass="btn btn-lg btn-block btn-primary mb-3" OnClick="btnModificarOrdenTrabajo_Click" runat="server" Text="Modificar" /><br />
