<%@ Page Title="Consultar Servicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarServicio.aspx.cs" Inherits="MiTallerMecanico.ConusltarServicio" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <asp:DropDownList ID="dpCampo" CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem Value="nombreServicio" Text="Nombre" />
                </asp:DropDownList>
            </div>
            <div class="col-md-4">
